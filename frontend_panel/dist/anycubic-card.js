    ...
    constructor({
      ...
      for (; null !== (r = et.nextNode()) && a.length < o;) {
        if (1 === r.nodeType) {
          ...
          } else t.startsWith(F) && (a.push({
            type: 6,
            index: n
          }), r.removeAttribute(t));
          if (Y.test(r.tagName)) {
            const t = r.textContent.split(F),
              e = t.length - 1;
            if (e > 0) {
          ...
          let t = -1;
          for (; -1 !== (t = r.data.indexOf(F, t + 1));) a.push({
            type: 7,
            index: n
          }), t += F.length - 1;
        }
